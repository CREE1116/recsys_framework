...
class ChebyshevLIRA(BaseModel):
    """
    ChebyshevLIRA - Minimax Polynomial Approximation of Wiener Filter.
    Approximates (S + λI)^-1 using Chebyshev Polynomials for O(nnz) fast inference.
    """
    def __init__(self, config, data_loader):
        super(ChebyshevLIRA, self).__init__(config, data_loader)
        ...
        self.K = model_config.get('K', 3)
        
        # ChebyshevLIRA Layer
        self.lira_layer = ChebyshevLIRALayer(
