...
class Infinity_AE(BaseModel):
    ...
    def fit(self, data_loader):
        print(f"\n[Infinity-AE] Fitting with lambda={self.reg_lambda}...")
        ...
        print("[Infinity-AE] Computing User-User Gram Matrix...")
        G = X @ X.t()  # (N x N)
        ...
        print(f"[Infinity-AE] Training complete via Kernel Method. Time: {elapsed:.2f}s")
