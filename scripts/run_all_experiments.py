...
def run_all_searches(model_config_files, dataset_config_path):
    ...
    for config_file in model_config_files:
        ...
        grid_search_script = os.path.join(os.path.dirname(__file__), 'grid_search.py')
        command = [
            sys.executable, 
            grid_search_script, 
...
if __name__ == '__main__':
    ...
    model_config_files_to_run = [
        ...
        # 'configs/model/general/slim.yaml',
        # 'configs/model/general/cooccurrence.yaml',
        # 'configs/model/general/naive_bayes.yaml',
        # 'configs/model/general/softplusmf.yaml',
        ...
        # 'configs/model/general/ultragcn.yaml',
        # 'configs/model/general/simgcl.yaml',

        # --- Autoencoders & Generative Models ---
        # 'configs/model/general/elsa.yaml',
        # 'configs/model/general/rlae.yaml',
        # 'configs/model/general/sansa.yaml',
        # 'configs/model/general/infinity_ae.yaml',
        # 'configs/model/general/svd_ae.yaml',
        # 'configs/model/general/ials.yaml',
        # 'configs/model/general/macr.yaml',

        # --- CSAR & LIRA Models ---
        # 'configs/model/csar/csar_basic.yaml',
        ...
        # 'configs/model/csar/ada_lira.yaml',
        # 'configs/model/csar/pair_lira.yaml',
    ]
